...
from src.models.inference import predict_on_tiled_image, save_results
from src.utils.eda import analyze_dataset, plot_class_distribution, plot_bbox_dimensions
...
def main():
    ...
    if args.command == "prepare":
        ...
        # Run inference
        result_image, _, _, _, _ = predict_on_tiled_image(
        ...
        if args.output:
            save_results(result_image, args.output)
        else:
            from src.models.inference import visualize_results
